    ...
    <section className="py-16 bg-gradient-to-r from-purple-500 to-pink-500 text-white">
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <button className="border rounded-lg border-white text-white px-8 py-3 !rounded-button text-lg font-medium hover:bg-white hover:text-blue-500 transition-all  shadow-lg">
            Sign Up Now
          </button>
          <button className="border rounded-lg border-white text-white px-8 py-3 !rounded-button text-lg font-medium hover:bg-white hover:text-blue-500 transition-all  shadow-lg ">
            Learn More
