...
function Photography() {
  ...
  return (
    <>
      <Header />
      <div className="min-h-screen pt-28 px-4 pb-16 bg-stone-50">
        <div className="max-w-6xl mx-auto">
          <h1 className="text-4xl font-bold text-center text-gray-800 mb-4">📸 Photography Showcase</h1>
          <p className="text-center text-gray-600 max-w-2xl mx-auto mb-10">
            Explore photography journeys, shared frames, and skill development stories from fellow creators.
          </p>

          {posts.length === 0 ? (
            <p className="text-center text-gray-500">No photography posts available yet.</p>
          ) : (
