...
function HeroSection() {
  ...
  return (
    <section
      className={`w-full relative overflow-hidden transition-opacity duration-700 ${show ? "opacity-100" : "opacity-0"
        }`}
      style={{
    ...
    >
      ...
      <div className="container mx-auto px-4 py-20 md:py-32 relative">
        <div className="max-w-2xl">
          <h1
            className={`text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 transform transition-all duration-700 ${show ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
              }`}
          >
          ...
          <p
            className={`text-xl md:text-2xl text-gray-700 mb-8 transform transition-all duration-700 delay-200 ${show ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
              }`}
          >
          ...
          <button
            className={`bg-[#7c3aed] text-white px-8 py-3 rounded-md text-lg font-medium 
                        ...
                        transform duration-300  ${show ? "opacity-100 scale-100" : "opacity-0 scale-95"
              }`}
          >
